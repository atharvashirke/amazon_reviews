...
# All the inofrmation pertaining to Amazon reviews of ORS (UK)
url = "https://www.amazon.co.uk/R-S-Hydration-Electrolyte-Tablets-Blackcurrant/product-reviews/B00NGTCKWS/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews&pageNumber=1"
start_page = 1
end_page = 7
time_upper_limit = 5
ors_reviews = "Amazon reviews"
    ...
    while start_page <= end_page :
        ...
        try:
            ...
            for review in reviews :
                ...
                start_page += 1
                print('csv body contains:' + csv_body)
